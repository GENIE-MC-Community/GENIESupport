...
if [ ! -f pythia6.tar.gz -o ${refetch} -ne 0 ] ; then
  ...
  echo "${fetchit}  https://raw.githubusercontent.com/GENIEMC/Pythia6Support/master/pythia6.tar.gz"
  ${fetchit}  https://raw.githubusercontent.com/GENIEMC/Pythia6Support/master/pythia6.tar.gz
fi
